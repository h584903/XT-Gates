...
<template>
  ...
  <template #item="{element, index}">
    <div :key="element.ID">
      <GateTask :taskID="element.ID" :step="element.step" :title="element.title" :duration="element.duration" :responsiblePerson="element.responsiblePerson" :complete-date="element.completeDate" :comment="element.comment || ''" />
      <div
