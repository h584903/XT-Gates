class taskModel {
    ...
    gateNR: number; /*NR på gate en task tilhører*/
    ...
    constructor(ID:number, prosjektID:number, gateNR:number, step:number, title:String, responsiblePerson:String, onTime:boolean, progress:number, duration:number) {
        this.ID = ID;
